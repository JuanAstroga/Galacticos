...
public class ListaUsuarios extends javax.swing.JFrame {
    ...
    public void mostrarUsuarios(){
        ...
        try {
            ...
            String sql = "SELECT u.*, r.nombre as nombre_rol FROM usuario u INNER JOIN rol r ON u.fkrol=r.id";
            ...
            while(datos.next()){
                ...
                String nombre_rol = datos.getString("nombre_rol");
                int fkrol = 0;
                Rol rol = new Rol(fkrol, nombre_rol);
    ...
    private void initComponents() {
        ...
        tabla_usuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido Paterno", "Apellido Materno", "Correo", "Estatus", "Acciones"
            }
        ));
